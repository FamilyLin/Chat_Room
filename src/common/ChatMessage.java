...
import static common.Constants.MESSAGE_BREAK;
import static common.Constants.MESSAGE_SEP;
...
public class ChatMessage {
    ...
    public String toMessageString() {
        ...
        ret.append(from).append(MESSAGE_SEP).append(to).append(MESSAGE_SEP).
                append(message).append(MESSAGE_BREAK);
        return ret.toString();
    }

    public static void main(String[] args) {
        ChatMessage chatMessage = new ChatMessage("testfrom",
                "testto", "这是一个消息");
